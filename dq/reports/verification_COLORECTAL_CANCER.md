# 검출 성능 검증: COLORECTAL_CANCER

- clean 데이터: 규칙 450개 실행, 위반 0건 (오탐)
- dirty 데이터: 주입 오류 109건 중 109건 검출, 재현율 1.0
- 오류 유형 35종 중 전부 검출 35종
- 주입 오류의 부수 효과로 함께 발화한 규칙: SEM-COM-006, SEM-COM-015, SEM-COM-028, SEM-COM-030
...
| BMI_MISMATCH | Plausibility | 3 | 3 | 1.0 |
| CODELIST | Conformance | 6 | 6 | 1.0 |
| COHORT_CONDITION_MISSING | Completeness | 2 | 2 | 1.0 |
| CONVERSION_REASON_MISSING | Completeness | 2 | 2 | 1.0 |
