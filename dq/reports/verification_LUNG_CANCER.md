...
- clean 데이터: 규칙 427개 실행, 위반 0건 (오탐)
- dirty 데이터: 주입 오류 109건 중 109건 검출, 재현율 1.0
- 오류 유형 34종 중 전부 검출 34종
- 주입 오류의 부수 효과로 함께 발화한 규칙: SEM-COM-006, SEM-COM-015, SEM-COM-030, SEM-LC-005
...
| SIZE_VS_TSTAGE | Plausibility | 2 | 2 | 1.0 |
| SMOKING_LOGIC | Plausibility | 2 | 2 | 1.0 |
